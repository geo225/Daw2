<div class="w3-container w3-light-grey" id="contact" style="margin-top:25px;width:90;">
    ...
    <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                <input class="w3-input w3-border form-control" type="number" min="-90" max="90" name="latitud" id="latitud" placeholder="-90 a 90" >
            </div>
        </div>
        <div class="form-group">
        <label for="longitud" class="col-xs-12 col-sm-3 col-md-3 col-lg-3 control-label w3-left">Longitud</label>
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                <input class="w3-input w3-border form-control" type="number" min="-90" max="90" name="longitud" id="longitud" placeholder="-90 a 90" >
            </div>
