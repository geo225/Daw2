<div class="container w3-light-grey" style="width:90%">
    <div class="row">
        <h1 class="w3-xxxlarge w3-text-red "><b>Borrar Perfil</b></h1>
        <hr style="width:50px;border:5px solid red" class="w3-round ">
    </div>
    <p> Estas Seguro de borrar el Perfil:</p>
    <form class="form-horizontal" id="formulario" name="FormularioEditar" action="index.php?pagina=borrarperfil" method="post">
