...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:40px" id="showcase">
    <h1 class="w3-xxlarge"><b>TEMA 6: PROGRAMACIÓN ORIENTADA A OBJETOS EN PHP</b></h1>
  </div>
		<div class="w3-container" id="packages" style="margin-top:35px">
    <h1 class="w3-xlarge w3-text-red"><b>Menu Tema 6</b></h1>
  ...
  <div class="w3-row-padding">
    <div class="w3-bar w3-margin-bottom">
      <ul class="w3-ul w3-light-grey w3-center">
        <li class="w3-red w3-xlarge w3-padding-16">TEMA 6</li>
        <li><a class="w3-hover-grey" href="LoginPoo-MVC/index.php">Login/Logoff POO-Multicapa </a></li>
		<li><a class="w3-hover-grey" href="#" >Mantenimiento Departamentos POO-Multicapa </a></li>
      </ul>
    </div>
  </div>
</div>
