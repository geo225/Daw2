...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
	<a href="login.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white"><img class="w3-margin-right" src="/DAW204/public_html/Images/006-flecha-atras.png"/>volver</a>
  </div>
</nav>
...
<?php
	...
	if (isset($_POST['enviarLogin'])){											
        ...
        if($consulta->rowCount()!=0){
                $mensajeError["errorUsuarioDuplicado"]="Esta Usuario ya esta en uso";   
			}	
		$conn = null;
...
//Formulario que se muestra si no se ha enviado el formulario o ha tenido errores
	...
	<!-- Formulario -->	
		...
		<form id="formulario" name="FormularioLogin" action="<?PHP echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <label>ID Ususario<span class="w3-text-red w3-margin-left"><?php echo $mensajeError['errorUsuario'];echo $mensajeError['errorUsuarioDuplicado'];?></span></label>
