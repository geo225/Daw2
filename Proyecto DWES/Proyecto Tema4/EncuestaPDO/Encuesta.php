...
<?php
	...
	$mensajeError = array(
		...
		"errorDni"=>null,
		"errorBday"=>null,
		"errorSatisfacion"=>null,
		"errorValoracion"=>null,
		"errorEmail"=>null,
		"errorOpinion"=>null,
	...
	if (isset($_POST['enviarFormulario'])){											
		...
		$mensajeError["errorDni"]=validacionDNI($_POST['dni']);
		$mensajeError["errorBday"]=validarFecha($_POST['bday']);
		$mensajeError["errorSatisfacion"]=comprobarEntero($_POST['satisfacion']);
		$mensajeError["errorValoracion"]=comprobarTexto($_POST['valoracion'],0,0,0);
		$mensajeError["errorEmail"]=validarEmail($_POST['email']);
		$mensajeError["errorOpinion"]=comprobarAlfaNumerico($_POST['opinion'],255,0,0);
