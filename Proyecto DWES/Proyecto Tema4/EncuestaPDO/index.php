  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    <h1 class="w3-jumbo"><b>Proyecto Encuesta</b></h1>
		...
		<div class="w3-container" id="contact" style="margin-top:75px;">
			...
			<a class="w3-hover-grey" href="Encuesta.php">Realizar Encuesta</a><a class="w3-right w3-hover-grey" href="resultado.php">Ver Resultados</a> <br/>
			<img class="w3-bar w3-centered" height="500px" src="Images/modeloNavegacion.png"/>
		</div>
</div>
