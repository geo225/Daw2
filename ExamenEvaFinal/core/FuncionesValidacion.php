<?php
	...
	// Blibioteca con funciones de validación
			...
			//Autor: Rodrigo
			//Fecha: 24/11/2017
			 function comprobarTexto($cadena,$maxTamanio=0,$minTamanio=0,$obligatorio=1){
			...
			function comprobarCodigo($cadena,$maxTamanio=0,$minTamanio=0,$obligatorio=1){
				// Patrón para campos de solo texto
				$patron_texto = "/^[a-zA-Z]+$/";
				$cadena=htmlspecialchars(strip_tags(trim((string)$cadena)));
				$correcto=null;
			...
			// Return null es correcto, si no muestra el mensaje de error
			// Si es un 1 es obligatorio, si es un 0 no lo es
			 function comprobarAlfaNumerico($cadena,$maxTamanio=0,$minTamanio=0,$obligatorio=1){
				$cadena=htmlspecialchars(strip_tags(trim((string)$cadena)));
				$correcto =null;
			...
			// Return null es correcto, si no muestra el mensaje de error
			// Si es un 1 es obligatorio, si es un 0 no lo es
			 function comprobarEntero($integer,$obligatorio=1){
				$correcto = null;
			...
			// Return null es correcto, si no muestra el mensaje de error
			// Si es un 1 es obligatorio, si es un 0 no lo es
			 function comprobarFloat($float,$obligatorio=1){
				$correcto = null;
			...
			// Return null es correcto, si no muestra el mensaje de error
			// Si es un 1 es obligatorio, si es un 0 no lo es
			 function validarEmail ($email,$maxTamanio=0,$minTamanio=0,$obligatorio=1){
				$correcto = null;
			...
			// Return null es correcto, si no muestra el mensaje de error
			// Si es un 1 es obligatorio, si es un 0 no lo es
			 function validarURL ($url,$obligatorio=1){
				$correcto = null;
			...
			//Autor: Rodrigo
			//Fecha: 24/11/2017
			function validarFecha ($fecha,$obligatorio=1){
				$correcto = null;
